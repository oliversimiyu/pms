...
<head>
    ...
    <title>Student Dashboard - Bumbe Technical Training Institute (BTTI) REQUISITION MANAGEMENT SYSTEM</title>
...
<body>
    ...
    <div class="container mt-4">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">BTTI Student Dashboard</h1>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-white"><?php echo $rejected_count; ?></div>
                                <div class="mt-2 mb-0 text-white">
                                    <a href="view_requisitions.php?status=rejected&user=<?php echo $user_id; ?>" class="text-white">View all</a>
                                </div>
                            </div>
                            <div class="col-auto">
        ...
        <div class="row">
            ...
            <div class="col-lg-5 mb-4">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold">Request Status Guide</h6>
                    </div>
                    <div class="card-body">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span><i class="bi bi-hourglass-split text-warning me-2"></i> Pending</span>
                                <span class="text-muted">Request is under review</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span><i class="bi bi-check-circle text-success me-2"></i> Approved</span>
                                <span class="text-muted">Request has been approved</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span><i class="bi bi-x-circle text-danger me-2"></i> Rejected</span>
                                <span class="text-muted">Request was not approved</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span><i class="bi bi-box-seam text-info me-2"></i> Processed</span>
                                <span class="text-muted">Resources have been provided</span>
                            </li>
                        </ul>
                    </div>
                </div>
